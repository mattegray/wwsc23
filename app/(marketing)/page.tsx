      ...
      <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
          <svg
            ...
            stroke="currentColor"
            strokeWidth="1"
            className="h-28 fill-current pb-6 md:h-36 md:pb-6 lg:h-48 lg:pb-8"
          >
          ...
          <blockquote className="max-w-[42rem] text-sm leading-normal text-muted-foreground md:text-base md:leading-8">
            <em>&quot;백성이 여호수아에게 말하되 우리 하나님 여호와를 우리가 섬기고<br />
            그의 목소리를 우리가 청종하리이다 하는지라&quot;<br />
            여호수아 24:24</em>
          </blockquote>
          <p className="max-w-[42rem] text-base leading-normal text-muted-foreground md:text-xl md:leading-8">
            ...
            <div className="relative overflow-hidden rounded-lg border bg-background p-2 hover:shadow-xl">
              <div className="flex h-[180px] flex-row  rounded-md p-8">
                ...
                <div className="space-y-2 pl-6">
                  <h2 className="text-xl font-bold sm:text-4xl">목사님 특강/저녁 집회</h2>
          ...
          <Link href="/">
            <div className="relative overflow-hidden rounded-lg border bg-background p-2 hover:shadow-xl">
              <div className="flex h-[180px] flex-row  rounded-md p-8">
                <Icons.clock size={48}/>
                <div className="space-y-2 pl-6">
                  <h2 className="text-xl font-bold sm:text-4xl">Time Table</h2>
                  <p className="text-base text-muted-foreground sm:text-lg">
                    App dir, Routing, Layouts, Loading UI and API routes.
                  </p>
                </div>
          ...
          <Link href="/">
            <div className="relative overflow-hidden rounded-lg border bg-background p-2 hover:shadow-xl">
              <div className="flex h-[180px] flex-row  rounded-md p-8">
                ...
                <div className="space-y-2 pl-6">
                  <h2 className="text-xl font-bold sm:text-4xl">Sessions</h2>
                  <p className="text-base text-muted-foreground sm:text-lg">
                    App dir, Routing, Layouts, Loading UI and API routes.
                  </p>
                </div>
          ...
          <Link href="/">
            <div className="relative overflow-hidden rounded-lg border bg-background p-2 hover:shadow-xl">
              <div className="flex h-[180px] flex-row  rounded-md p-8">
                <Icons.book size={48}/>
                <div className="space-y-2 pl-6">
                  <h2 className="text-xl font-bold sm:text-4xl">Materials</h2>
                  <p className="text-base text-muted-foreground sm:text-lg">
                    App dir, Routing, Layouts, Loading UI and API routes.
                  </p>
                </div>
          ...
          <Link href="/">
            <div className="relative overflow-hidden rounded-lg border bg-background p-2 hover:shadow-xl">
              <div className="flex h-[180px] flex-row  rounded-md p-8">
                <Icons.globe size={48}/>
                <div className="space-y-2 pl-6">
                  <h2 className="text-xl font-bold sm:text-4xl">Beyond We Will</h2>
                  <p className="text-base text-muted-foreground sm:text-lg">
                    App dir, Routing, Layouts, Loading UI and API routes.
                  </p>
                </div>
          ...
          <Link href="/">
            <div className="relative overflow-hidden rounded-lg border bg-background p-2 hover:shadow-xl">
              <div className="flex h-[180px] flex-row  rounded-md p-8">
                <Icons.users size={48}/>
                <div className="space-y-2 pl-6">
                  <h2 className="text-xl font-bold sm:text-4xl">Our Team</h2>
                  <p className="text-base text-muted-foreground sm:text-lg">
                    App dir, Routing, Layouts, Loading UI and API routes.
                  </p>
                </div>
